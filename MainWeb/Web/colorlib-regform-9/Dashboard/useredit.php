...
if(isset($_POST['edit_user'])) {
    ...
    $sql = "SELECT * FROM users WHERE email = '$_POST[user_emaill]'";
...
if(isset($_POST['email']) ) {
    ...
    $sql = "UPDATE users SET name='$_POST[name]' , email = '$_POST[email]' , password = '$_POST[password]' WHERE email = '$_POST[user_emaill]'";
    $q = mysqli_query($con, $sql);
    if (mysqli_query($con, $sql)) {
        $userdata = mysqli_fetch_assoc($q);
    }else {
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="adduser.php" class="nav-item nav-link"><i class="fa fa-user-edit"></i>Add User</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <form action="" method="post">
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="form-floating mb-3">  
                                <input type="text" name='name' value="<?= $userdata['name'] ?>" class="form-control" id="floatingInput" placeholder="Username">
                                <label for="floatingInput">Username</label>
                            </div>
                            <div class="form-floating mb-3">  
                                <input type="email" name='email' value="<?= $userdata['email'] ?>" class="form-control" id="floatingInput" placeholder="name@example.com">
                                <label for="floatingInput">Email address</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" name='password' value="<?= $userdata['password'] ?>" class="form-control" id="floatingPassword" placeholder="Password">
