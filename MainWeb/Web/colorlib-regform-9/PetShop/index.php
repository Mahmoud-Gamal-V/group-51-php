        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <p class="fs-4 text-white mb-lg-4">Regular walks, hiking, playing fetch and swimming can keep your pet physically active and fit. But don't forget about mental stimulation</p>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>make your furry friend feel at home</p>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>All types of dry delicious food </p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Get your pet a fresh haircut</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>This step-by-step dog training guide will get you started. We will show u everything you need to know to completely train your dog.</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Exercise helps to lower blood pressure and build up muscle.
                                 It'll even help your pet have healthy bones. Walking also helps your dog to poo and wee so they'll be less likely to get constipation or a urinary tract infection</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>We have highly trained vets to make your buddy feel better</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="bg-light text-center pt-5">
                        ...
                        <div class="text-center p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <span>2 times pet grooming</span>
                                <i class="bi bi-check2 fs-4 text-primary"></i>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <span>1 time vet checkup</span>
                                <i class="bi bi-x fs-4 text-danger"></i>
                            </div>
                            <a href="" class="btn btn-primary text-uppercase py-2 px-4 my-3">Order Now</a>
                        </div>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel bg-white p-5">
                        <div class="testimonial-item text-center">
                            ...
                            <p>This is the best pet shop around. Good knowledgeable proprietors and great products. If they don’t have what you’re looking for, ask and they may be able to get it. If your pet has special dietary needs, Jen can and will help. </p>
                            <hr class="w-25 mx-auto">
                            <h5 class="text-uppercase">Jenna</h5>
                            <span>Nurse</span>
                        </div>
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-4">
                            ...
                            <p>Best pet shop around. They are knowledgeable and some of the best people you will ever meet. I started going there when my cat got sick and I needed to find special food for her to eat. They were so helpful. I won’t buy from anyone else</p>
                            <hr class="w-25 mx-auto">
                            <h5 class="text-uppercase">James</h5>
                            <span>Engineer</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-0 bg-light overflow-hidden">
                            ...
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                <div class="p-4">
                                    ...
                                    <h5 class="text-uppercase mb-3">Corgi for extra wiggle</h5>
                                    <p>doggo story in the rain</p>
                                    <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-0 bg-light overflow-hidden">
                            ...
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                <div class="p-4">
                                    ...
                                    <h5 class="text-uppercase mb-3">Susage dog contemplating his existence</h5>
